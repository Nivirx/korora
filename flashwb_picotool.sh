...
/opt/picotool load --ignore-partitions -t bin include/cyw43-firmware/43439A0.bin -o 0x10300000

# Load Bluetooth firmware @ 1MiB + 256KiB, 16 KiB hole
/opt/picotool load --ignore-partitions -t bin include/cyw43-firmware/43439A0_btfw.bin -o 0x10340000

# load CLM firmware @ 1MiB + 256KiB + 16 KiB
/opt/picotool load --ignore-partitions -t bin include/cyw43-firmware/43439A0_clm.bin -o 0x10344000
